...
const mockCourses: Course[] = [
  {
    ...
    code: 'CS101',
    description: 'Learn the fundamentals of programming and computer science concepts including algorithms, data structures, and software development.',
  ...
  },
  {
    ...
    code: 'CS201',
    description: 'Master essential data structures and algorithmic problem-solving techniques for efficient software development.',
  ...
  },
  {
    ...
    code: 'CS301',
    description: 'Design and implement efficient database systems and learn query optimization techniques.',
  ...
  },
  {
    ...
    code: 'CS401',
    description: 'Explore AI and machine learning algorithms for real-world applications and data analysis.',
  ...
  },
  {
    ...
    code: 'CS350',
    description: 'Learn software development methodologies, testing, and project management for large-scale applications.',
            ...
            <div className="card-header-linkedin">
              <div className="flex justify-between items-start mb-4">
                <div className="flex-1">
                  ...
                  <p className="text-blue-600 font-medium text-sm">{course.code}</p>
                </div>
            ...
            <div className="card-body-linkedin">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center text-sm">
                  ...
                  <span className="text-gray-700">{course.days.join(', ')}</span>
                </div>
              ...
              <div className="mb-4">
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="text-gray-600">{course.enrolled}/{course.capacity}</span>
                </div>
